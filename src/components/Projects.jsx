...
const projects = [
  ...
  },
  {
    ...
    LiveDemo:
      "https://rock-paper-scissors-7m9ck5sjh-avanimalethas-projects.vercel.app/",
  },
  {
    name: "Meme-Gen",
    technologies: "JavaScript ",
          ...
          {visibleProjects.map((project, index) => (
            ...
            >
              ...
              <div className="flex">
                <a
                  href={project.github}
                  className="inline-block bg-gradient-to-r from-gray-800 to-gray-900 text-white px-4 py-2 rounded-full mx-2"
                  target="_blank"
